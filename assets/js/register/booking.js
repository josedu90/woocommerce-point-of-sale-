        ...
        is_bookable: function (date) {
            ...
            if (!bookable) {
                ...
                if ($picker.data('is_range_picker_enabled')) {
                    ...
                    var restricted_days = product.booking.Datetime_Picker.restricted_days;
                    if(typeof restricted_days[date.getDay()] === "undefined"){
                        css_classes += "ui-datepicker-unselectable ui-state-disabled ";
                    }
