    ...
    var wc_pos_barcode_options = {
        init: function () {
            $('#edit_wc_pos_barcode')
                ...
                .on('click', '.meta_removable button', this.remove_attributes);
        ...
        print_barcodes: function () {
            ...
            switch (type) {
                case 'continuous_feed':
                    ...
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('a4').removeClass('letter').removeClass('per_sheet_80').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'a4':
                    $('#printable_barcode').addClass('a4');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('continuous_feed').removeClass('letter').removeClass('per_sheet_80').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'letter':
                    $('#printable_barcode').addClass('letter');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('continuous_feed').removeClass('a4').removeClass('per_sheet_80').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'per_sheet_30':
                    $('#printable_barcode').addClass('per_sheet_30');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_80').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'per_sheet_80':
                    $('#printable_barcode').addClass('per_sheet_80');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'a4_30':
                    $('#printable_barcode').addClass('a4_30');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('per_sheet_80').removeClass('a4_27');
                    break;
                case 'con_4_3':
                    $('#printable_barcode').addClass('con_4_3');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('per_sheet_80').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'con_4_2':
                    $('#printable_barcode').addClass('con_4_2');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_3').removeClass('per_sheet_80').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'jew_50_10':
                    $('#printable_barcode').addClass('jew_50_10');
                    $('#printable_barcode').removeClass('con_4_2').removeClass('con_4_3').removeClass('per_sheet_80').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('a4_30').removeClass('a4_27');
                    break;
                case 'a4_27':
                    $('#printable_barcode').addClass('a4_27');
                    $('#printable_barcode').removeClass('jew_50_10').removeClass('con_4_2').removeClass('con_4_3').removeClass('continuous_feed').removeClass('a4').removeClass('letter').removeClass('per_sheet_30').removeClass('per_sheet_80').removeClass('a4_30');
                    break;
            }
            window.print();
        },
        ...
        fields_to_print: function () {
            ...
            var field_sku_label = $('#field_sku_label').is(':checked');
            ...
            $('#order_line_items .item').each(function (index, el) {
                ...
                if (field_sku) {
                    ...
                    if(field_sku_label)
                        sku = '<span class="barcode_sku">' + sku + '</span>';
                    $barcode_text.append(sku).append('<br />');
                }
                if (field_name) {
                    var name = $(el).find('.wc-order-item-name').text();
                    name = '<span class="barcode_name">' + name + '</span>';
                    $barcode_text.append(name);
                }
                if (field_price) {
                    var amount = $(el).find('.product_price').text();
                    amount = '<span class="barcode_amount">' + amount + '</span>';
                    $barcode_text.append(amount);
                }
                if (field_meta_value) {
                    ...
                    $.each(meta, function (k, v) {
                        ...
                        text = '<span class="meta_removable">' + text + ' <button></button></span>';
