...
return array(
    ...
    57 => __('Searching for', 'wc_point_of_sale'),
    58 => __('Offline function is enabled and products are being downloaded in background', 'wc_point_of_sale'),
    59 => __('Please generate an order ID', 'wc_point_of_sale'),
    60 => __('SKU:', 'wc_point_of_sale'),
    61 => __('Stock:', 'wc_point_of_sale'),
    62 => __('Product data could not be loaded', 'wc_point_of_sale'),
    63 => __('Please fill in all the required fields in customer details', 'wc_point_of_sale')
);
