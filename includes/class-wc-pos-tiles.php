    ...
    class WC_Pos_Tiles
    {
        ...
        public function add_tiles($grids_single_record)
        {
            ...
            <div class="wrap woocommerce">
                <h2><?php _e(ucfirst($grids_single_record[0]->name) . ' Grid Layout', 'wc_point_of_sale') ?></h2>
                <br class="clear"/>
                <div id="col-container">
                    ...
                    <div id="col-left">
                        ...
                        <form action="" method="post" class="addGirdLayout" id="serach_tile_product" autocomplete="off">
                            <div class="col-wrap">
                                <div class="form-wrap">
                                    <h2><?php _e('Add New Tile', 'wc_point_of_sale') ?></h2>
                                    ...
                                    <div id="category_type_wrap">
                                        <div class="form-field">
                                            <label for="category_type"><?php _e('Automatic Loading', 'wc_point_of_sale'); ?></label>
                                            <select id="category_type" class="category_type" style="width: 294px;" name="category_type">
                                                ...
                                                <option value="auto"><?php echo __('Automatic', 'wc_point_of_sale'); ?></option>
                                                <option value="manual"><?php echo __('Manual', 'wc_point_of_sale'); ?></option>
                                            </select>
                                            <p class="description"><?php _e('Select whether tiles should be populated automatically according to the category or statically load products from the category.', 'wc_point_of_sale'); ?></p>
                                        </div>
                                    </div>
