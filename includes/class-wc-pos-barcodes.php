...
class WC_Pos_Barcodes {
	...
	public function display_single_barcode_page()
	{
		?>
		<div class="wrap">
			<h2><?php _e( 'Barcode Label Printing', 'wc_point_of_sale' ); ?></h2>
			<p><?php _e( 'Barcode labels for your store can be printed here. To change the the fields to print in the label, you can check the boxes for the labels to print in the panel to the right.', 'wc_point_of_sale' ); ?></p>
								...
								<div class="inside" id="barcode_print_settings">
									...
									<div>
										...
										<select id="label_type" name="label_type" class="wc-enhanced-select">
										 <optgroup label="<?php _e( 'Continuous', 'wc_point_of_sale' ); ?>">
										 ...
										 <optgroup label="<?php _e( 'A4', 'wc_point_of_sale' ); ?>">
										 <option value="a4"><?php _e( '2 x 7', 'wc_point_of_sale' ); ?></option>
										 <option value="a4_30"><?php _e( '3 x 7', 'wc_point_of_sale' ); ?></option>
										 <option value="a4_27"><?php _e( '3 x 9', 'wc_point_of_sale' ); ?></option>
										 </optgroup>
										 <optgroup label="<?php _e( 'Letter', 'wc_point_of_sale' ); ?>">
										 <option value="letter"><?php _e( '4 x 5', 'wc_point_of_sale' ); ?></option>
										 <option value="per_sheet_30"><?php _e( '3 x 10', 'wc_point_of_sale' ); ?></option>
										 <option value="per_sheet_80"><?php _e( '4 x 20', 'wc_point_of_sale' ); ?></option>
										 </optgroup>
										 <optgroup label="<?php _e( 'Other', 'wc_point_of_sale' ); ?>">
										 <option value="jew_50_10"><?php _e( 'Jewellery Tag (50mm x 10mm)', 'wc_point_of_sale' ); ?></option>
										 </optgroup>
										</select>
									</div>
									<div>
										<label for="label_fields"><?php _e( 'Product Fields', 'wc_point_of_sale' ); ?></label>
										...
										<div><label><input type="checkbox" name="fields_print" class="fields_to_print"  id="field_sku_label"><?php _e( 'SKU Label', 'wc_point_of_sale' ); ?></label></div>
										<div><label><input type="checkbox" name="fields_print" class="fields_to_print"  id="field_name" checked="checked"><?php _e( 'Product Name', 'wc_point_of_sale' ); ?></label></div>
										<div><label><input type="checkbox" name="fields_print" class="fields_to_print" id="field_price" checked="checked"><?php _e( 'Price', 'wc_point_of_sale' ); ?></label></div>
                                        <div><label><input type="checkbox" name="fields_print" class="fields_to_print"  id="field_meta_value"><?php _e( 'Variation', 'wc_point_of_sale' ); ?></label></div>
                                        <div><label><input type="checkbox" name="fields_print" class="fields_to_print"  id="field_meta_title"><?php _e( 'Variation Label', 'wc_point_of_sale' ); ?></label></div>
									</div>
									<div>
										<p class="description" style="margin-top: 1em;"><?php _e( 'Note: set your paper size to the corresponding template size. Printing margins should be set to none to ensure accurate printing.', 'wc_point_of_sale' ); ?></p>
									</div>
