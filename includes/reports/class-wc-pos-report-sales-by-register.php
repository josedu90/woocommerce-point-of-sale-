...
class WC_POS_Report_Sales_By_Register extends WC_Admin_Report {
	...
	public function products_widget() {
		...
		<div class="section">
			<form method="GET">
				<div>
					<select class="wc-product-search" style="width:203px;" name="register_ids[]" data-placeholder="<?php _e( 'Search for a register&hellip;', 'wc_point_of_sale' ); ?>" data-action="wc_pos_json_search_registers"></select>
