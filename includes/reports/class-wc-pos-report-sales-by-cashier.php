...
public $chart_colours      = array();
	...
	public function products_widget() {
		...
		<div class="section">
			<form method="GET">
				<div>
					<select class="wc-product-search" style="width:203px;" name="cashier_ids[]" data-placeholder="<?php _e( 'Search for a cashier&hellip;', 'wc_point_of_sale' ); ?>" data-action="wc_pos_json_search_cashier"> </select>
