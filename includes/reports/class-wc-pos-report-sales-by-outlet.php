...
class WC_POS_Report_Sales_By_Outlet extends WC_Admin_Report {
	...
	public function products_widget() {
		...
		<div class="section">
			<form method="GET">
				<div>
                    <select class="wc-product-search" style="width:203px;" name="outlet_ids[]" data-placeholder="<?php _e( 'Search for a outlet&hellip;', 'wc_point_of_sale' ); ?>" data-action="wc_pos_json_search_outlet" ></select>
