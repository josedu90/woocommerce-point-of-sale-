...
<div id="woocommerce-order-items">
    <div class="woocommerce_order_items_wrapper wc-order-items-editable">
        <table cellspacing="0" cellpadding="0" class="woocommerce_order_items wp-list-table" id="barcode_generator">
            <thead>
            <tr>
                <th class="item" colspan="2"><?php _e('Item', 'wc_point_of_sale'); ?></th>
                <th class="item_cost"><?php _e('Cost', 'wc_point_of_sale'); ?></th>
                <th class="quantity"><?php _e('Qty', 'wc_point_of_sale'); ?></th>
                <th class="line_cost"><?php _e('Barcode', 'wc_point_of_sale'); ?></th>
