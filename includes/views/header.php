	...
	<style>
		@media only screen and (min-width: 1024px) {
			...
			#wc-pos-actions a.button:hover {
				color: <?php echo get_option('woocommerce_pos_register_base_color', '#96588a') ?>;
			}
		}
		...
		#regiser_top_bar #pos_user_badge .button:hover {
			background: <?php echo get_option('woocommerce_pos_register_base_color', '#96588a') ?>;
			opacity: .75;
		}
        ...
        #modal-refund .wrap-button input:checked + label.pos_register_toggle{
			background: <?php echo get_option('woocommerce_pos_register_base_color', '#96588a') ?> !important;
		}
		.loadie {
			background-color: <?php echo get_option('woocommerce_pos_register_base_color', '#96588a') ?>;
		}
	</style>
	<?php
...
$wc_pos_tile_layout = get_option('wc_pos_tile_layout', 'image_title_price');
...
$admin_body_class .= ' tile_colour_' . get_option('wc_pos_tile_colour') . ' tile_size_' . get_option('wc_pos_tile_size', 'square');
