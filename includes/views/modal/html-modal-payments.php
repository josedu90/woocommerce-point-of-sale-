                            ...
                            <div class="media-frame-wrap">
                                <div class="payment_box payment_method_<?php echo $gateway->id; ?>">
                                    ...
                                    if ($gateway->id == 'pos_chip_pin' || $gateway->id == 'pos_chip_pin2' || $gateway->id == 'pos_chip_pin3') {
                                        ?>
                                        <div class="pos_chip_pin_order_id">
	                                        <div class="pos_chip_pin_order_label">
	                                        	<label for"generate_order_id"><?php _e('Order Number', 'wc_point_of_sale'); ?></label>
                                        	</div>
                                        	<div class="pos_chip_pin_order_generate">
	                                        	<a id="generate_order_id"><?php _e('Generate', 'wc_point_of_sale'); ?></a>
                                        	</div>
                                        </div>
                                        <p><?php _e('Click Generate to obtain a reference number for your order. Then process the payment using your chip & PIN device.', 'wc_point_of_sale'); ?></p>
                                        <?php
