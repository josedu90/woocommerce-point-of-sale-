        ...
        <div id="discount_tab" class="discount_section popup_section" style="display: block;">
            ...
            <div class="media-frame-wrap">
				<div class="discount-reason">
	                <label for="discount-reason"><?php _e('Reason', 'wc_point_of_sale') ?></label>
	                <select id="discount-reason">
	                    <option value="none"><?php _e('None', 'wc_point_of_sale') ?></option>
	                    <option value="waste"><?php _e('Wastage', 'wc_point_of_sale') ?></option>
	                    <option value="damaged"><?php _e('Damaged', 'wc_point_of_sale') ?></option>
	                    <option value="manager"><?php _e('Manager Approved', 'wc_point_of_sale') ?></option>
	                    <option value="general"><?php _e('General', 'wc_point_of_sale') ?></option>
	                    <option value="student"><?php _e('Student Discount', 'wc_point_of_sale') ?></option>
	                    <option value="member"><?php _e('Member Discount', 'wc_point_of_sale') ?></option>
	                </select>
	            </div>
