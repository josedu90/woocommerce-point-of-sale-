<style>
    ...
    body.pos_receipt, table.order-info, table.receipt_items, table.customer-info, #pos_receipt_title, #pos_receipt_address, #pos_receipt_contact, #pos_receipt_header, #pos_receipt_footer, #pos_receipt_tax, #pos_receipt_info, #pos_receipt_items, pos_receipt_tax_breakdown, table.tax_breakdown, div#pos_receipt_wifi, #pos_receipt_socials {
	...
	#pos_customer_info, #pos_receipt_title, #pos_receipt_logo, #pos_receipt_contact, #pos_receipt_tax, #pos_receipt_header, 		#pos_receipt_items, .display-socials, #pos_receipt_address, #pos_receipt_info, div#pos_receipt_wifi, #pos_receipt_socials {
...
<div class="pos_receipt">
    ...
    <div id="pos_receipt_contact" class="show_receipt_print_outlet_contact_details">
        <span id="print-telephone_label"><?php echo $receipt_options['telephone_label']; ?></span><span
                class="colon">:</span> 0123-456-7890
        <br>
    ...
    <div id="pos_receipt_wifi">
        <span id="print-wifi_label"><?php echo __('Wi-Fi Network', 'wc_point_of_sale'); ?></span><span class="colon">:</span>
        Network Name
        <br>
        <span id="print-wifi_label"><?php echo __('Wi-Fi Password', 'wc_point_of_sale'); ?></span><span class="colon">:</span>
        Network Password
    </div>
    <div id="pos_receipt_socials" class="display-socials header"
        ...
        <div class="display-facebook" 
             style="display: <?php echo ($receipt_options['show_facebook'] == 'yes') ? 'block' : 'none' ?>">
            Facebook
        </div>
        <div class="display-instagram" 
             style="display: <?php echo ($receipt_options['show_instagram'] == 'yes') ? 'block' : 'none' ?>">
            Instagram
        </div>
        <div class="display-snapchat" 
             style="display: <?php echo ($receipt_options['show_snapchat'] == 'yes') ? 'block' : 'none' ?>">
            Shop
        </div>
    </div>
    ...
    <div id="pos_receipt_socials" class="display-socials footer"
         style="display: <?php echo ($receipt_options['socials_display_option'] != 'none' && $receipt_options['socials_display_option'] == 'header') ? 'block' : 'none' ?>">
        <div class="display-twitter"
             style="display: <?php echo ($receipt_options['show_twitter'] == 'yes') ? 'block' : 'none' ?>">
            Twitter
