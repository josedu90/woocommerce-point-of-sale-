...
<div class="wrap" id="wc-pos-registers-edit">
    <div id="regiser_top_bar">
        ...
        <div class="wp-heading" id="pos_register_buttons">
            <?php $current_user = wp_get_current_user(); ?>
            <a class="pos_register_user_panel <?php echo get_option('woocommerce_pos_register_branding', 'no') ?>"
               target="_blank"
                ...
                <div id="postbox-container-<?php echo ($revert_columns == 'no' || !$revert_columns) ? '1' : '2' ?>"
                    ...
                    <div id="wc-pos-actions" class="postbox">
                        ...
                        <?php if (get_option('wc_pos_refund', 'no') == 'yes') {
                                if(get_option('wc_pos_refund_approval', 'no') == 'no' || (get_option('wc_pos_refund_approval', 'no') == 'yes' && get_user_meta(get_current_user_id(), 'approve_refunds', true) == 'yes')) {
                                    ?>
...
<!--                                                            --><?php //$get_order_currency = WC_VERSION >= 3 ? $order->get_currency() : $order->get_order_currency(); ?>
<!--                                                            <span id="formatted_order_discount">--><?php //echo wc_price($d, array('currency' => $get_order_currency)); ?><!--</span>-->
<!--                                                        </td>-->
<!--                                                    </tr>-->
<!--                                                --><?php //} ?>
