...
// don't load directly
    ...
    do_action('wc_pos_footer_scripts');
        ...
        <div class="md-content">
            ...
            <table id="selected-variation-data">
                <tr>
                    ...
                    <td class="variation-price-sku"><span class="selected-variation-sku"
                                                          style="font-family: Consolas, Monaco, monospace;"></span></td>
                </tr>
                <tr>
                    <?php
            ...
            <div class="wrap-button wrap-button-center">
                ...
                <a class="button alignleft" href="#reset"
                   id="reset_selected_variation"><?php _e('Reset Variation', 'wc_point_of_sale'); ?></a>
    ...
    <?php require_once('modal/html-modal-refund.php'); ?>
    ...
    <?php require_once('modal/html-modal-customer-search-card.php'); ?>
    ...
    <?php require_once('modal/html-modal-custom-order-fields.php'); ?>

    <?php require_once('modal/html-modal-dining-option.php'); ?>
    <?php
    if (get_option('wc_pos_tabs_management', 'no') == 'yes') {
        require_once('modal/html-modal-tabs.php');
    }
    ?>
...
<script>
    if(wc_stripe_params && !wc_stripe_params.sepa_elements_options){
