    ...
    <table class="product-fields-table" data-required="{{required}}">
        <tr>
            ...
            <td>
                ...
                <label class="pos_addon_label pos_addon_text">
                    <input type="number" step="any" data-raw-price="{{price}}" data-price="{{price}}" data-addon="{{json this}}"
                           placeholder="{{name}}{{{accountingPOS price}}}"
                           class="input-text addon addon-input_multiplier {{type}}_{{@index}} {{type}}_{{@index}}_0"
                           {{product_addons_max this}} {{product_addons_min this}}>
            ...
            <td colspan="2">
                ...
                {{#case 'images'}}
                {{#each options}}
                <label class="pos_addon_label image_label">{{label}}{{{accountingPOS price}}}
                    <input type="radio" data-raw-price="{{price}}" data-price="{{price}}"
                           class="addon addon-radio {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}"
                           name="{{../type}}_{{@../index}}">
                    <span class="pos_image"><img src="{{image_src}}" alt=""></span>
                </label>
                {{/each}}
                {{/case}}
                {{/switch}}
