...
class WC_POS_Admin_Setup_Wizard
{
    ...
    public function setup_wizard()
    {
        ...
        wp_localize_script( WC_POS_TOKEN . '-setup', 'wc_pos_params',
    ...
    public function wc_pos_setup_outlet()
    {
        ...
        <form method="post">
            ...
            <p><a class="button" href="" id="use_store_address"><?php _e('Use Store Address', 'wc_point_of_sale') ?></a></p>
    ...
    public function wc_pos_setup_general_options()
    {
        ...
        $order_prompt = get_option('wc_pos_order_prompt', 'no');
        ...
        <form method="post">
            <table class="form-table" cellspacing="0">
                ...
                <tr>
                    <th scope="row"><label
                                for="wc_pos_order_prompt"><?php echo _e('Save Prompt', 'wc_point_of_sale'); ?></label>
                    </th>
                    <td>
                        <input type="checkbox" id="wc_pos_order_prompt" <?php checked($order_prompt, 'yes'); ?>
                               name="wc_pos_order_prompt" class="input-checkbox" value="1"/>
                        <label for="wc_pos_order_prompt"><?php _e('Display order save prompt', 'wc_point_of_sale'); ?></label>
                        <p class="description"><?php _e('Check this box display a confirmation prompt when saving an order.', 'wc_point_of_sale'); ?></p>
                    </td>
                </tr>
                <?php
                wc_pos_select(array(
    ...
    public function wc_pos_setup_ready()
    {
        ...
        <form action="//actualityextensions.us7.list-manage.com/subscribe?u=d360506c406997bb1eb300ec9&id=3a2056f6b4" method="post" target="_blank" novalidate>
