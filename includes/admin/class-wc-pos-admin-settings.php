    ...
    class WC_POS_Admin_Settings extends WC_Admin_Settings
    {
        ...
        public static function get_settings_pages()
        {
            if (empty(self::$settings)) {
                ...
                $settings[] = include(WC_POS()->plugin_path() . '/includes/admin/settings/wc-pos-settings-restaurant.php');
                $settings[] = include(WC_POS()->plugin_path() . '/includes/admin/settings/wc-pos-settings-cloud-print.php');
                $settings[] = include(WC_POS()->plugin_path() . '/includes/admin/settings/wc-pos-settings-license.php');
                $settings[] = include(WC_POS()->plugin_path() . '/includes/admin/settings/wc-pos-settings-system-status.php');
                if(class_exists('acf') || class_exists('WC_Product_Addons')){
                    $settings[] = include(WC_POS()->plugin_path() . '/includes/admin/settings/wc-pos-settings-integrations.php');
                }
