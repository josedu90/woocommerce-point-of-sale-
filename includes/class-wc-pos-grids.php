...
class WC_Pos_Grids {
	...
	public function output() {
		...
		if ( 'add' === $action || 'edit' === $action ) {
            ...
            $auto_tiles_view  = ( isset( $_POST['grid_auto_tiles_view'] ) ) ? (string) stripslashes( $_POST['grid_auto_tiles_view'] ) : 'products';
			...
			if ( ! empty( $error ) ) {
				...
				if ( 'add' === $action ) {
					...
					$grid = array(
                        ...
                        'auto_tiles_view' => $auto_tiles_view
					);
	...
	public function edit_grid() {
        ...
        $grid_auto_tiles_view = $grid_to_edit->auto_tiles_view;
			...
			<form action="admin.php?page=wc_pos_grids&amp;edit=<?php echo absint( $edit ); ?>" method="post">
				<table class="form-table">
					<tbody>
                        ...
                        <tr class="form-field form-required">
                            <th scope="row" valign="top">
                                <label for="grid_auto_tiles_view"><?php _e( 'Automatic Tiles View', 'woocommerce' ); ?></label>
                            </th>
                            <td>
                                <select name="grid_auto_tiles_view" id="grid_auto_tiles_view">
                                    <option value="categories" <?php selected('categories', $grid_auto_tiles_view, true ); ?> ><?php _e( 'Categories', 'woocommerce' ); ?></option>
                                    <option value="products" <?php selected('products', $grid_auto_tiles_view, true ); ?> ><?php _e( 'Products', 'woocommerce' ); ?></option>
                                </select>
                                <p class="description"><?php _e( 'Determines how tiles appear on the grid when using automatic category tles.', 'wc_point_of_sale' ); ?></p>
                            </td>
                        </tr>
					</tbody>
				</table>
