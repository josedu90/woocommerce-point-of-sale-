    ...
    class WC_Pos_Receipts
    {
                                ...
                                <div class="meta-box-sortables">
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        ...
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_twitter"><?php _e('Twitter', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="show_twitter" value="yes"
                                                       name="show_twitter" <?php echo ($receipt_options['show_twitter'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_facebook"><?php _e('Facebook', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_instagram"><?php _e('Instagram', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_snapchat"><?php _e('Snapchat', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <hr>
                                            <p class="form-field">
                                                <label class="receipt_labels" for="receipt_print_outlet_wifi_details"><?php _e('Wi-Fi Details', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="receipt_print_outlet_wifi_details"
                                                       value="yes"
                                                       name="receipt_print_outlet_wifi_details" <?php echo ($receipt_options['print_wifi'] == 'yes') ? 'checked="checked"' : ''; ?>>
                                            </p>
                                            <hr>
	                                        <p class="form-field">
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        ...
	                                        <hr>
                                            <p class="form-field">
                                                <label class="receipt_labels" for="receipt_print_tab"><?php _e('Tax', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="receipt_print_tax" value="yes"
                                                       name="receipt_print_tax" <?php echo (isset($receipt_options['print_tax']) && $receipt_options['print_tax'] == 'yes') ? 'checked="checked"' : ''; ?>>
                                            </p>
	                                        <p class="form-field">
        ...
        public function save_receipt()
        {
            ...
            $data = array(
                ...
                'print_tax' => isset($_POST['receipt_print_tax']) ? $_POST['receipt_print_tax'] : 'no',
                'print_wifi' => isset($_POST['receipt_print_outlet_wifi_details']) ? $_POST['receipt_print_outlet_wifi_details'] : 'no',
            );
            $table_name = $wpdb->prefix . "wc_poin_of_sale_receipts";
        ...
        public function get_style_templates()
        {
            ...
            $templates = array(
                ...
                'contact_position' => array(
                    'left' => 'div#pos_receipt_address, div#pos_receipt_contact, div#pos_receipt_wifi, div.display-socials {text-align: left;}',
                    'center' => 'div#pos_receipt_address, div#pos_receipt_contact, div#pos_receipt_wifi, div.display-socials {text-align: center;}',
                    'right' => 'div#pos_receipt_address, div#pos_receipt_contact, div#pos_receipt_wifi, div.display-socials {text-align: right;}',
                ),
